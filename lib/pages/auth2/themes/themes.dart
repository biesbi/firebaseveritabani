...
import '../../auth2/themes/app_theme.dart';
...
final Map<ThemesModes, AppColorTheme> themes = {
  ...
  ThemesModes.light: AppColorTheme(
      ...
      primaryBackgroudColor: Color.fromARGB(255, 48, 137, 153),
  ...
  ThemesModes.dark: AppColorTheme(
      primaryColor: const Color.fromARGB(255, 48, 137, 153),
      primaryBackgroudColor: const Color.fromARGB(255, 18, 18, 18),
      primaryIconColor: Color.fromARGB(255, 255, 255, 255),
      ...
      sidebar: SideBarTheme(
          ...
          backgroudColor: Color.fromARGB(255, 48, 137, 153),
