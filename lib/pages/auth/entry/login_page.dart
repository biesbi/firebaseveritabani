...
import '../../../store/auth/auth.reducer.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Center forgotPasswordButton() {
    return Center(
      child: TextButton(
        onPressed: () {
          Navigator.pushReplacementNamed(context, "/resetPage");
        },
        child: customText(
          "Sifremi Unuttum",
  ...
  Widget signInButton() {
    return StoreConnector<AppState, Function(User?)>(converter: (store) {
      return (User? user) =>
          store.dispatch(AppPayload(type: AuthActions.SET_USER, payload: user));
